...
This contract allows users to stake ERC20 tokens, which are deposited in Yearn Vaults and the yield generated is sent to one receiver. yDonate automatically detects the vault for the token staked by using the [Yearn Registry](https://docs.yearn.finance/getting-started/products/addresses)
